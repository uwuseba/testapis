...
<form id="form1" name="form1" method="post" action="index?view=delete">
  <table   class='table table-hover table-responsive table-bordered'>
    ...
    <tr>
      <td colspan="2"><input type="submit" name="ids" id="ids" value="Delete" class='btn btn-primary pull-right m-b-15px create-product-button' />
